/*
 * $Id: ShadowRenderer.java,v 1.6 2006/10/23 18:24:50 gfx Exp $
 *
...
/**
 * <p>
 * A shadow renderer generates a drop shadow for any given picture, respecting the transparency
 * channel if present. The resulting picture contains the shadow only and to create a drop shadow
 * effect you will need to stack the original picture and the shadow generated by the renderer.
 * </p>
 ...
 * </ul>
 * You can set these properties using the provided mutaters or the appropriate constructor. Here are
 * two ways of creating a green shadow of size 10 and with an opacity of 50%:
 * 
 * <pre>
 ...
 * <p>
 * A shadow is generated as a <code>BufferedImage</code> from another <code>BufferedImage</code>.
 ...
 * {@link #addPropertyChangeListener}. Listening to properties changes is very useful when you
 * emebed the renderer in a graphical component and give the API user the ability to access the
 * renderer. By listening to properties changes, you can easily repaint the component when needed.
 * </p>
 * <h2>Threading Issues</h2>
 * <p>
 * <code>ShadowRenderer</code> is not guaranteed to be thread-safe.
 * </p>
 * 
...
public class ShadowRenderer
{
	...
	/**
	 * <p>
	 * Creates a default good looking shadow generator. The default shadow renderer provides the
	 ...
	 * </p>
	 * <ul>
	 * <li><i>size</i>: The size, in pixels, of the shadow. This property also defines the
	 * fuzzyness.</li>
	 * <li><i>opacity</i>: The opacity, between 0.0 and 1.0, of the shadow.</li>
	 * <li><i>color</i>: The color of the shadow. Shadows are not meant to be black only.</li>
	 * </ul>
	 ...
	 * </p>
	 * <p>
	 * The opacity is comprised between 0.0f and 1.0f; 0.0f being fully transparent and 1.0f fully
	 * opaque.
	 * </p>
	 * 
	 ...
	 * <p>
	 * The opacity is comprised between 0.0f and 1.0f; 0.0f being fully transparent and 1.0f fully
	 * opaque. If you provide a value out of these boundaries, it will be restrained to the closest
	 * boundary.
	 * </p>
	 * 
	 * @param shadowOpacity
	 ...
	 * </p>
	 * <p>
	 * There is virtually no limit to the size. The size cannot be negative. If you provide a
	 * negative value, the size will be 0 instead.
	 * </p>
	 * 
	 * @param shadowSize
