 ...
 * is convex if its edges are convex, and an edge is convex if the centroid of each adjacent plane
 * is clearly <i>below</i> the plane of the other face. The centroid is considered below a plane if
 * its distance to the plane is less than the negative of a {@link #getDistanceTolerance() distance
